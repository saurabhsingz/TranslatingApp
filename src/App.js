...
function App() {
  ...
  function getlanguagesource() {
    ...
    axios.post("https://libretranslate.de/detect", data1).then((response) => {
  ...
  function translatetext() {
    ...
    if (data.q == "") {
      ...
      resultsettxt("*Please Select Desired Language");
    else {
      axios
        ...
        <div className="col-md-12">
          ...
          <div className="form-group shadow-textarea mt-4">
            <textarea
              ...
              id="exampleFormControlTextarea6"
              rows="5"
              placeholder="Translated Text will show Here..."
              value={resulttxt}
            ></textarea>
          </div>
          <button onClick={translatetext} className="btn btn-primary">
            Translate
          </button>
        </div>
      </div>
